...
public interface ProductListRepository extends JpaRepository<ProductList, Long> {
    @Query(value = "select p.*, b.brand_name, s.shop_name, c.category_name, var.product_var_type_name, cur.currency_name from products p " +
    ...
    ProductList findItemById(Long id);
