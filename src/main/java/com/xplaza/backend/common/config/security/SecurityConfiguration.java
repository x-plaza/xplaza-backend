 ...
 */
package com.xplaza.backend.common.config.security;
...
import com.xplaza.backend.common.config.security.filter.JwtRequestFilter;
  ...
  public SecurityFilterChain defaultSecurityFilterChain(JwtRequestFilter filterApiRequest, HttpSecurity http)
    ...
    return http.sessionManagement(
        ...
        .authorizeHttpRequests(authorize -> authorize
            .requestMatchers("/actuator/health", "/api/v1/authenticate", "/v3/api-docs/**", "/swagger-ui/**")
            .permitAll()
